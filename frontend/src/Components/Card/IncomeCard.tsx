...
const IncomeCard:React.FC<CardTransaction> = (props) => {
  ...
  return (
    ...
    <div className={`flex lg:w-fit   justify-center  text-sm ${props.bgColor} hover:shadow-md hover:cursor-pointer space-x-1 py-1 m-auto ${props.textColor} rounded-md px-2`}>
